...
import com.cracker.mybatis.datasource.DataSourceFactory;
...
import com.cracker.mybatis.session.LocalCacheScope;
...
public class XMLConfigBuilder extends BaseBuilder {
     ...
     * <plugins>
     * <plugin interceptor="com.cracker.mybatis.test.plugin.TestPlugin">
    ...
    private void pluginElement(Element parent) throws Exception {
        ...
        for (Element element : elements) {
            ...
            // 获取插件实现类并实例化：com.cracker.mybatis.test.plugin.TestPlugin
     ...
     *
     *   <mapper class="com.cracker.mybatis.test.dao.IUserDao"/>
     * </mappers>
     */
