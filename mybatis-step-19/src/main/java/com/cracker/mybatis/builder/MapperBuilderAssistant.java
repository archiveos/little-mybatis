...
import com.cracker.mybatis.cache.decorators.FifoCache;
import com.cracker.mybatis.cache.impl.PerpetualCache;
import com.cracker.mybatis.executor.keygen.KeyGenerator;
import com.cracker.mybatis.mapping.*;
import com.cracker.mybatis.mapping.*;
import com.cracker.mybatis.reflection.MetaClass;
...
public class MapperBuilderAssistant extends BaseBuilder {
    ...
    public MappedStatement addMappedStatement(
        ...
        // 给id加上namespace前缀：com.cracker.mybatis.test.dao.IUserDao.queryUserInfoById
    ...
    private void setStatementResultMap(
         ...
         * <select id="queryUserInfoById" resultType="com.cracker.mybatis.test.po.User">
    ...
    public ResultMap addResultMap(String id, Class<?> type, List<ResultMapping> resultMappings) {
        // 补全ID全路径，如：com.cracker.mybatis.test.dao.IActivityDao + activityMap
        id = applyCurrentNamespace(id, false);
    ...
    public Cache useNewCache(Class<? extends Cache> typeClass,
        ...
        // 建造者模式构建 Cache [currentNamespace=com.cracker.mybatis.test.dao.IActivityDao]
